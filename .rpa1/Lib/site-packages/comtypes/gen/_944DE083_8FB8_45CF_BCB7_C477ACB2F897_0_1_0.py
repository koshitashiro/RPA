...
__all__ = [
    'DockPosition_None', 'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_FontSizeAttributeId', 'UIA_IsReadOnlyAttributeId',
    'UIA_StructureChangedEventId',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_IndentationFirstLineAttributeId', 'IUIAutomationElement2',
    'UIA_LabeledByPropertyId', 'UIA_AutomationPropertyChangedEventId',
    'TextEditChangeType_CompositionFinalized',
    'NavigateDirection_PreviousSibling', 'IUIAutomation3',
    'TreeScope_Descendants', 'UIA_LandmarkTypePropertyId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'AnnotationType_Mathematics', 'UIA_SayAsInterpretAsAttributeId',
    'TreeScope', 'PropertyConditionFlags_IgnoreCase',
    'UIA_Selection2ItemCountPropertyId', 'UIA_ObjectModelPatternId',
    ...
    'NotificationProcessing_All', 'UIA_TransformPattern2Id',
    'UIA_OrientationPropertyId', 'IAccessible',
    'AnnotationType_GrammarError',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_IsControlElementPropertyId', 'IUIAutomation5',
    'IUIAutomationTextRangeArray', 'UIA_MenuModeStartEventId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'StyleId_BulletedList', 'StyleId_Heading3',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_RadioButtonControlTypeId', 'UIA_RangeValueValuePropertyId',
    'UIA_TabItemControlTypeId', 'UIA_TableRowOrColumnMajorPropertyId',
    'IUIAutomationDropTargetPattern',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'StructureChangeType_ChildRemoved', 'IUIAutomationTreeWalker',
    'UIA_IndentationLeadingAttributeId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_WindowCanMinimizePropertyId',
    'IUIAutomationRangeValuePattern', 'TreeTraversalOptions',
    'ExtendedProperty', 'AnnotationType_Sensitive',
    'UIA_ToolTipControlTypeId', 'StructureChangeType',
    'UIA_ButtonControlTypeId', 'UIA_ActiveTextPositionChangedEventId',
    'UIA_TabControlTypeId', 'UIA_SelectionPattern2Id',
    ...
    'StyleId_Heading4', 'UIA_RangeValueSmallChangePropertyId',
    'UIA_IsEnabledPropertyId', 'TextEditChangeType_None',
    'ProviderOptions_ClientSideProvider',
    'UIA_ScrollBarControlTypeId', 'IUIAutomationTextEditPattern',
    'UIA_SelectionActiveEndAttributeId', 'UIA_MenuClosedEventId',
    'UIA_TransformPatternId', 'UIA_CaretPositionAttributeId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_MarginTopAttributeId',
    'IUIAutomationStructureChangedEventHandler', 'ScrollAmount',
    'CoalesceEventsOptions_Disabled',
    'UIA_Transform2ZoomMinimumPropertyId', 'UIA_SummaryChangeId',
    'UIA_GroupControlTypeId', 'IUIAutomationSelectionItemPattern',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'IUIAutomationPropertyCondition', 'NavigateDirection_FirstChild',
    'UIA_ClickablePointPropertyId', 'HeadingLevel5',
    'UIA_SpreadsheetPatternId', 'IUIAutomationEventHandler',
    'TextEditChangeType_AutoCorrect', 'IUIAutomationElementArray',
    'TreeScope_Parent', 'IUIAutomationElement6',
    'UIA_Drag_DragCompleteEventId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_Text_TextChangedEventId', 'UIA_StyleIdAttributeId',
    'UIA_TextControlTypeId', 'NotificationKind_ItemRemoved',
    'SynchronizedInputType_LeftMouseUp',
    'AnnotationType_CircularReferenceError', 'ZoomUnit_NoAmount',
    'IUIAutomationCondition', 'UIA_FillColorPropertyId',
    'UIA_NavigationLandmarkTypeId', 'IUIAutomationScrollItemPattern',
    'UIA_OutlineColorPropertyId',
    'UIA_IsDragPatternAvailablePropertyId', 'IUIAutomation4',
    ...
    'UIA_IsKeyboardFocusablePropertyId', 'RowOrColumnMajor',
    'UIA_Selection_InvalidatedEventId', 'OrientationType_None',
    'AnnotationType_DataValidationError',
    'UIA_RangeValueLargeChangePropertyId', 'AnnotationType_Header',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_ToolTipOpenedEventId', 'UIA_CulturePropertyId',
    'IUIAutomationPropertyChangedEventHandler', 'TextUnit',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_TableColumnHeadersPropertyId',
    'AnnotationType_ExternalChange', 'StyleId_Heading5',
    'IUIAutomationVirtualizedItemPattern',
    'IUIAutomationNotCondition', 'HeadingLevel4',
    ...
    'ExpandCollapseState_Expanded', 'SupportedTextSelection',
    'UIA_InputReachedOtherElementEventId', 'NotificationProcessing',
    'ExpandCollapseState_Collapsed', 'IUIAutomationProxyFactoryEntry',
    'UIA_SelectionSelectionPropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'IUIAutomationNotificationEventHandler',
    'ProviderOptions_ProviderOwnsSetFocus', 'UIA_DockPatternId',
    'UIA_HasKeyboardFocusPropertyId', 'IUIAutomationDockPattern',
    'IUIAutomationSpreadsheetItemPattern',
    'AnnotationType_InsertionChange', 'DockPosition_Fill',
    'UIA_TableControlTypeId', 'UIA_HeaderControlTypeId',
    'UIA_BulletStyleAttributeId', 'UIA_GridItemColumnSpanPropertyId',
    'UIA_TablePatternId', 'IUIAutomationProxyFactory',
    'StyleId_Heading1', 'UIA_MarginBottomAttributeId',
    'IUIAutomationItemContainerPattern',
    'SynchronizedInputType_KeyDown',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_Drag_DragStartEventId', 'UIA_SizeOfSetPropertyId',
    'UIA_TitleBarControlTypeId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'AnnotationType_DeletionChange',
    'IUIAutomationMultipleViewPattern', 'ZoomUnit_SmallDecrement',
    'UIA_ValuePatternId', 'UIA_DropTarget_DragLeaveEventId',
    'ExpandCollapseState', 'AnnotationType_Unknown',
    'UIA_ProgressBarControlTypeId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'SynchronizedInputType_RightMouseUp', 'StyleId_NumberedList',
    'AnnotationType_Comment', 'UIA_TransformCanRotatePropertyId',
    'UIA_ExpandCollapsePatternId', 'UIA_HyperlinkControlTypeId',
    'UIA_GridItemContainingGridPropertyId',
    'UIA_PositionInSetPropertyId',
    'WindowInteractionState_ReadyForUserInteraction',
    'IUIAutomationProxyFactoryMapping',
    'PropertyConditionFlags_MatchSubstring', 'HeadingLevel8',
    'AnnotationType_SpellingError', 'UIA_AriaPropertiesPropertyId',
    'UIA_AsyncContentLoadedEventId', 'UIA_EditControlTypeId',
    'IUIAutomationElement7',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_IsHiddenAttributeId', 'UIA_MenuBarControlTypeId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_ScrollPatternId', 'UIA_ForegroundColorAttributeId',
    'UIA_ScrollItemPatternId', 'UIA_FontWeightAttributeId',
    'NotificationKind_Other', 'IUIAutomationTextRange3',
    'UIA_ToolBarControlTypeId', 'PropertyConditionFlags_None',
    'TreeTraversalOptions_PostOrder', 'UIA_MenuModeEndEventId',
    ...
    'UIA_MenuOpenedEventId', 'UIA_TextFlowDirectionsAttributeId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_ClassNamePropertyId', 'TextUnit_Format',
    'IUIAutomationTextPattern',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'ExpandCollapseState_PartiallyExpanded', 'UIA_ListControlTypeId',
    'HeadingLevel9', 'WindowVisualState_Minimized',
    'IUIAutomationSelectionPattern', 'TreeScope_Subtree',
    'UIA_TextEdit_TextChangedEventId', 'UIA_SelectionPatternId',
    'UIA_SpinnerControlTypeId', 'AnnotationType_Author',
    'StyleId_Custom', 'UIA_Selection2FirstSelectedItemPropertyId',
    'IUIAutomationGridPattern', 'UIA_ItemStatusPropertyId',
    'AnnotationType_FormulaError', 'ProviderOptions_UseComThreading',
    'UIA_SelectionItemPatternId', 'AnnotationType_FormatChange',
    'DockPosition_Right', 'UIA_SystemAlertEventId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'NotificationProcessing_ImportantMostRecent', 'ToggleState_On',
    'AutomationElementMode', 'StyleId_Normal',
    'UIA_DropTarget_DroppedEventId',
    'NotificationKind_ActionCompleted',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_StylesFillPatternStylePropertyId', 'UIA_TextPatternId',
    'StyleId_Subtitle', 'IUIAutomationTogglePattern',
    'UIA_DataGridControlTypeId', 'UIA_CustomControlTypeId',
    'UIA_ControlTypePropertyId', 'IUIAutomation',
    'UIA_ListItemControlTypeId', 'UIA_SizePropertyId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'ScrollAmount_LargeIncrement', 'TextPatternRangeEndpoint',
    'WindowVisualState_Maximized', 'IUIAutomationOrCondition',
    'UIA_Invoke_InvokedEventId', 'UIA_InputDiscardedEventId',
    'OrientationType_Vertical', 'UIA_IsDialogPropertyId',
    'OrientationType', 'UIA_RotationPropertyId', 'WindowVisualState',
    'TextUnit_Word',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_LinkAttributeId', 'UIA_ComboBoxControlTypeId',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_GridItemColumnPropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_ThumbControlTypeId', 'UIA_GridItemRowPropertyId',
    'UIA_DropTargetPatternId', 'UIA_SpreadsheetItemFormulaPropertyId',
    'StyleId_Heading8', 'UIA_AccessKeyPropertyId',
    ...
    'IUIAutomationBoolCondition', 'UIA_CenterPointPropertyId',
    'IUIAutomationScrollPattern', 'AnnotationType_Footnote',
    'SupportedTextSelection_Single',
    'NotificationProcessing_MostRecent',
    'UIA_SelectionItemSelectionContainerPropertyId', 'HeadingLevel3',
    'OrientationType_Horizontal', 'UIA_DescribedByPropertyId',
    'UIA_WindowPatternId', 'UIA_IsDockPatternAvailablePropertyId',
    'UIA_UnderlineColorAttributeId', 'ZoomUnit', 'TextUnit_Document',
    'UIA_StrikethroughStyleAttributeId', 'AutomationElementMode_Full',
    'UIA_LegacyIAccessiblePatternId', 'UIA_ItemTypePropertyId',
    'AnnotationType_Footer', 'RowOrColumnMajor_ColumnMajor',
    'TextUnit_Paragraph', 'UIA_SeparatorControlTypeId',
    'UIA_SearchLandmarkTypeId', 'UIA_IsContentElementPropertyId',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_StrikethroughColorAttributeId', 'IUIAutomationElement4',
    'UIA_SynchronizedInputPatternId', 'TreeScope_Ancestors',
    'ProviderOptions_UseClientCoordinates',
    'AnnotationType_UnsyncedChange', 'IUIAutomationElement9',
    'SynchronizedInputType_KeyUp', 'RowOrColumnMajor_Indeterminate',
    'UIA_LiveRegionChangedEventId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_AriaRolePropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_ControllerForPropertyId', 'StyleId_Heading6',
    'IUIAutomationExpandCollapsePattern',
    'UIA_AcceleratorKeyPropertyId', 'AutomationElementMode_None',
    'DockPosition_Top', 'IUIAutomationInvokePattern', 'StyleId_Quote',
    'UIA_DragPatternId', 'IUIAutomationTextRange',
    'UIA_TabsAttributeId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_DragDropEffectsPropertyId', 'UIA_StatusBarControlTypeId',
    'UIA_SliderControlTypeId', 'IUIAutomationEventHandlerGroup',
    'UIA_AnnotationObjectsAttributeId', 'HeadingLevel7',
    'IUIAutomationTransformPattern2', 'ExpandCollapseState_LeafNode',
    'NotificationKind_ItemAdded',
    'UIA_IsTextEditPatternAvailablePropertyId', 'HeadingLevel2',
    'UIA_WindowWindowVisualStatePropertyId', 'DockPosition',
    'UIA_StylesStyleNamePropertyId', 'UIA_Window_WindowOpenedEventId',
    'UIA_AutomationIdPropertyId', 'UIA_FlowsFromPropertyId',
    'ToggleState_Indeterminate',
    'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_InputReachedTargetEventId', 'UIA_MenuControlTypeId',
    'ScrollAmount_SmallDecrement', 'LiveSetting',
    'UIA_Transform2CanZoomPropertyId',
    'UIA_OutlineThicknessPropertyId',
    'UIA_TableItemRowHeaderItemsPropertyId', 'StyleId_Heading9',
    'IUIAutomationElement3',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_IsOffscreenPropertyId', 'ZoomUnit_LargeIncrement',
    'UIA_AnnotationPatternId', 'UIA_ToggleToggleStatePropertyId',
    'UIA_LayoutInvalidatedEventId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_TreeItemControlTypeId', 'UIA_GridColumnCountPropertyId',
    'UIA_AppBarControlTypeId', 'UIA_CaretBidiModeAttributeId',
    'StructureChangeType_ChildAdded', 'StyleId_Heading7',
    'UIA_FormLandmarkTypeId', 'UIA_GridPatternId', 'ToggleState',
    'UIA_IsSubscriptAttributeId', 'UIA_TableRowHeadersPropertyId',
    'UiaChangeInfo', 'UIA_NamePropertyId',
    'IUIAutomationTextPattern2', 'UIA_FullDescriptionPropertyId',
    'DockPosition_Left', 'UIA_StylesFillPatternColorPropertyId',
    ...
    'IUIAutomationSpreadsheetPattern', 'HeadingLevel_None',
    'UIA_StylesExtendedPropertiesPropertyId',
    'ZoomUnit_LargeDecrement', 'UIA_DropTarget_DragEnterEventId',
    'TextEditChangeType', 'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_TextPattern2Id', 'UIA_LevelPropertyId',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_WindowIsModalPropertyId', 'IUIAutomationCacheRequest',
    'DockPosition_Bottom', 'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_InvokePatternId', 'UIA_TreeControlTypeId',
    'UIA_Selection2CurrentSelectedItemPropertyId', 'Assertive',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_IsScrollPatternAvailablePropertyId',
    'CoalesceEventsOptions_Enabled',
    'IUIAutomationTextEditTextChangedEventHandler',
    'TextUnit_Character', 'UIA_RuntimeIdPropertyId',
    'UIA_TextChildPatternId', 'IUIAutomationSelectionPattern2',
    'UIA_IsPasswordPropertyId', 'UIA_VisualEffectsPropertyId',
    'NavigateDirection', 'UIA_IsDataValidForFormPropertyId',
    'UIA_OverlineStyleAttributeId',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_MarginLeadingAttributeId', 'UIA_IsActiveAttributeId',
    'HeadingLevel6', 'UIA_SayAsInterpretAsMetadataId',
    'UIA_HelpTextPropertyId', 'NotificationKind',
    'UIA_OutlineStylesAttributeId', 'AnnotationType_TrackChanges',
    'TreeScope_None', 'WindowInteractionState',
    'UIA_TransformCanResizePropertyId', 'UIA_StyleNameAttributeId',
    'CUIAutomation', 'IUIAutomationElement',
    ...
    'IUIAutomationValuePattern', 'SynchronizedInputType',
    'UIA_AnnotationTypesAttributeId', 'UIA_LiveSettingPropertyId',
    'UIA_WindowIsTopmostPropertyId', 'PropertyConditionFlags',
    'UIA_IsTablePatternAvailablePropertyId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_GridItemRowSpanPropertyId', 'TextUnit_Line',
    'UIA_CapStyleAttributeId', 'WindowVisualState_Normal',
    'UIA_CustomNavigationPatternId', 'WindowInteractionState_Running',
    'NavigateDirection_Parent', 'SupportedTextSelection_None',
    'IUIAutomationSynchronizedInputPattern', 'ToggleState_Off',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_DragIsGrabbedPropertyId', 'IUIAutomationTransformPattern',
    'NotificationProcessing_ImportantAll',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId', 'CUIAutomation8',
    'AnnotationType_ConflictingChange',
    'ProviderOptions_OverrideProvider', 'UIA_ChangesEventId',
    'WindowInteractionState_NotResponding',
    'UIA_IsDropTargetPatternAvailablePropertyId', 'IUIAutomation6',
    'TextPatternRangeEndpoint_End',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_DragGrabbedItemsPropertyId',
    'StructureChangeType_ChildrenInvalidated', 'IUIAutomation2',
    'UIA_AnimationStyleAttributeId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'AnnotationType_MoveChange', 'UIA_Transform2ZoomLevelPropertyId',
    'TextUnit_Page', 'Off', 'UIA_MainLandmarkTypeId',
    'UIA_BackgroundColorAttributeId', 'IUIAutomationTableItemPattern',
    'UIA_SelectionItem_ElementSelectedEventId', 'StyleId_Heading2',
    'IUIAutomationElement5', 'NotificationKind_ActionAborted',
    'RowOrColumnMajor_RowMajor', 'UIA_CalendarControlTypeId',
    'IUIAutomationTextRange2', 'ProviderOptions', 'StyleId_Emphasis',
    'UIA_FrameworkIdPropertyId', 'TreeTraversalOptions_Default',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_AnnotationDateTimePropertyId',
    'UIA_RangeValueMinimumPropertyId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_ItemContainerPatternId', 'IUIAutomationGridItemPattern',
    'UIA_ValueIsReadOnlyPropertyId', 'Polite',
    'TextEditChangeType_Composition', 'UIA_GridRowCountPropertyId',
    ...
    'IRawElementProviderSimple', 'IUIAutomationAnnotationPattern',
    'UIA_PaneControlTypeId', 'ConnectionRecoveryBehaviorOptions',
    'UIA_TogglePatternId', 'ScrollAmount_LargeDecrement',
    'UIA_IsSuperscriptAttributeId', 'TreeScope_Element',
    'UIA_IsPeripheralPropertyId',
    'UIA_LegacyIAccessibleSelectionPropertyId', 'StyleId_Title',
    'UIA_RangeValueIsReadOnlyPropertyId', 'UIA_StylesShapePropertyId',
    'WindowInteractionState_Closing', 'UIA_ProcessIdPropertyId',
    'UIA_TransformCanMovePropertyId', 'UIA_UnderlineStyleAttributeId',
    ...
    'UIA_StylesFillColorPropertyId', 'UIA_DataItemControlTypeId',
    'HeadingLevel1', 'UIA_HorizontalTextAlignmentAttributeId',
    'IUIAutomationTextChildPattern', 'UIA_DockDockPositionPropertyId',
    'TreeScope_Children', 'TextPatternRangeEndpoint_Start',
    ...
    'IUIAutomationElement8', 'UIA_NotificationEventId',
    'UIA_SemanticZoomControlTypeId', 'UIA_CultureAttributeId',
    'UIA_RangeValuePatternId', 'UIA_Transform2ZoomMaximumPropertyId',
    'UIA_DragDropEffectPropertyId', 'ScrollAmount_NoAmount',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'NavigateDirection_NextSibling', 'UIA_FlowsToPropertyId',
    'TextEditChangeType_AutoComplete',
    'UIA_AnnotationObjectsPropertyId', 'ZoomUnit_SmallIncrement',
    'UIA_HeaderItemControlTypeId'
]

_check_version('1.1.14', 1681038120.080819)
